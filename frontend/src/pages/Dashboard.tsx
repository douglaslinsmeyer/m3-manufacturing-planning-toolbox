...
const stats = [
  ...
  { name: 'Deliveries', key: 'totalDeliveries', href: '/deliveries', icon: TruckIcon, color: 'success' },
          ...
          <div className="rounded-lg bg-white p-4 sm:p-5 lg:p-8 shadow-sm ring-1 ring-slate-200">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              >
                ...
                <span className="text-sm font-medium text-slate-700">View Production Timeline</span>
              </Link>
              <Link
                to="/inconsistencies"
                className="flex items-center gap-2 rounded-md border border-slate-200 p-2.5 transition-colors hover:bg-slate-50 no-underline"
              ...
              >
                ...
                <span className="text-sm font-medium text-slate-700">Browse Customer Orders</span>
              </Link>
            </div>
          </div>
        </div>
